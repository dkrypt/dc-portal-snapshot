  ...
  return (
    <Fragment>
      <Tab.Container id="left-tabs-example" defaultActiveKey="first">
              ...
              >
                ...
                >
                  <div className="middleItem">
                    ...
                    <br></br>
                    <span
                      style={{ width: "158px", marginTop: "20px" }}
                      className="card_title"
                    >
                      User
                    </span>
        ...
        <Row>
          <Col sm={12} style={{ display: "flex", marginTop: "20px" }}>
            <Col sm={4}>
              <div
                className="Card card-1 center"
                // style={{ width: "20vw", height: "30vh" }}
